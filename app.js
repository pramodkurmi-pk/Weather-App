...
let dateOnly = currentdate.toLocaleDateString(undefined, options);  

date.innerHTML=`<p>${dateOnly} | ${time}</p>`;

// api key and selected form elements
const API_KEY = `4698578ff02582d194b0357f504da8fd`
